	...
	<div class="content">
		...
		<article class="article">		
			<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
				...
				<br>
				<div class="sbar">
		        <strong>Job Summary</strong></div> 
		        <strong>Published-on:</strong> <?php echo(types_render_field( "published-on", array( 'raw => true') )); ?><br>
		        <strong>Job Post:</strong> <?php echo(types_render_field( "job-post", array( 'raw => true') )); ?><br>
		        <strong>Job Nature:</strong> <?php echo(types_render_field( "job-nature", array( 'raw => true') )); ?><br>
				<strong>Salary:</strong> <?php echo(types_render_field( "salary2", array( 'raw => true') )); ?><br>
				<strong>Job Location:</strong> <?php echo(types_render_field( "job-location", array( 'raw => true') )); ?><br>
				<strong>Job Vacancy:</strong> <?php echo(types_render_field( "vacancy", array( 'raw => true') )); ?><br>
				<strong>Job Experience:</strong> <?php echo(types_render_field( "experience", array( 'raw => true') )); ?><br>
				<div class="job-deadline">
				<strong>Job Deadline:</strong> <?php echo(types_render_field( "job-deadline", array( 'raw => true') )); ?><br>
				</div>
				
				</div>
				<br>
				<div class="sbar">
		        <strong>Job Description</strong></div> 
						...
						<?php }?>  
						<div class="how-to-apply"></div>
							<hr><center><strong>How To Apply:<br></strong><?php echo(types_render_field( "how-to-apply", array( 'raw => true') )); ?><hr>
				<div class="job-deadline">
				<strong>Job Deadline:</strong> <?php echo(types_render_field( "job-deadline", array( 'raw => true') )); ?><br>
...
<div class="sbar">
		        <strong>You are here for</strong></div> 
		<center>
		<br>
<?php the_tags( ' ', ' • ', '<br />' ); ?>
<hr>
